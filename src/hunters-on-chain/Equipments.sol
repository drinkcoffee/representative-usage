// Copied from: https://explorer.immutable.com/address/0x67eC3365a8b0Ee22Ef3EebE723C90927A14f064A?tab=contract
...
contract Equipments is ImmutableERC1155 {
    ...
    constructor(address admin, address minter, address locker, address _royaltyReceiver,
     ...
     address royaltyAllowlist)  ImmutableERC1155(
            admin,
            "Equipment",
            baseURI,
            contractURI,
